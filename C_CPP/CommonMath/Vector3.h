...
public:
	...
	inline float Dot(const Vector3& other) const { return DirectX::XMVectorGetX(DirectX::XMVector3Dot(m_vec, other.m_vec)); }
	inline Vector3 Cross(const Vector3& other) const { return Vector3(DirectX::XMVector3Cross(m_vec, other.m_vec)); }
...
inline float Dot(const Vector3& v1, const Vector3& v2) { return DirectX::XMVectorGetX(DirectX::XMVector3Dot(v1.m_vec, v2.m_vec)); }
inline Vector3 Cross(const Vector3& v1, const Vector3& v2) { return Vector3(DirectX::XMVector3Cross(v1.m_vec, v2.m_vec)); }
