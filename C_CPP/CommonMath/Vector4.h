...
public:
	...
	inline Vector4(const Vector3& v) : m_vec(v.ToXMVECTOR()) {}
	inline Vector4(const DirectX::XMFLOAT3& v) : m_vec(DirectX::XMVectorSet(v.x, v.y, v.z, 1.0f)) {}
	...
	//연산자재정의
	inline Vector4 operator=(const Vector3& other) const { return Vector4(other.ToXMVECTOR()); }
	...
	inline float Dot(const Vector4& other) const { return DirectX::XMVectorGetX(DirectX::XMVector4Dot(m_vec, other.m_vec)); }
