...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// m_Model 객체 초기화
	if (!m_Model->Initialize(m_Direct3D->GetDevice(), "../RasterTek09/data/cube.txt", L"../RasterTek09/data/seafloor.dds"))
	{
...
bool GraphicsClass::Render(float rotation)
{
	...
	viewMatrix = XMMatrixLookAtLH(XMLoadFloat3(&m_Camera->GetPosition()), XMVectorZero(), {0.0f, 1.0f, 0.0f, 0.0f});	//0,0,0 을 바라보게 한다
