...
uint32_t EngineSystem::GetRenderPassKey_Pass(E_RenderPass pass)
{
...
uint32_t EngineSystem::GetRenderPassKey_DistToCamera(float dist)
{
...
_RPKey EngineSystem::GenerateRenderPassHash(uint32_t hashPass, uint32_t hashShaders, uint32_t hashStates, uint32_t hashResources, uint32_t hashDist)
{
	_RPKey key = 0;
