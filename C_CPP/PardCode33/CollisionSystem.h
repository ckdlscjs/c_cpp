...
public:
	...
	size_t CreateCollider(const std::wstring& szName, const std::vector<Vector3>* iTriangleCount, E_Collider collider);	//컬라이더 템플릿 혹은 인자를 받아서 형에맞게끔 제작해줄것인가 분기함수
...
private:
	...
	float fSphereTesselateFactor = 1.0f;
