...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 지면 모델 객체를 초기화합니다.
	result = m_GroundModel->Initialize(m_Direct3D->GetDevice(), "../Dx11Demo_43/data/floor.txt", L"../Dx11Demo_43/data/stone.dds");
	if(!result)
	{
	...
	// 큐브 모델 객체를 초기화 합니다.
	result = m_CubeModel->Initialize(m_Direct3D->GetDevice(), "../Dx11Demo_43/data/cube.txt", L"../Dx11Demo_43/data/seafloor.dds");
	if(!result)
	{
