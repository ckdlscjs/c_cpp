...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 모델 객체 초기화
	if(!m_Model->Initialize(m_Direct3D->GetDevice(), L"../RasterTek16/data/seafloor.dds", "../RasterTek16/data/sphere.txt"))
	{
...
bool GraphicsClass::Frame(float rotationY, float rotationX)
{
	// 카메라 위치 설정
