...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 모델 객체 초기화
	if (!m_Model->Initialize(m_Direct3D->GetDevice(), "../RasterTek21/data/cube.txt",	L"../RasterTek21/data/stone02.dds",
													L"../RasterTek21/data/bump02.dds", L"../RasterTek21/data/spec02.dds"))
	{
