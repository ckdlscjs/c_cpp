...
{
	// 정점 및 픽셀 쉐이더를 초기화합니다.
	return InitializeShader(device, hwnd, L"../RasterTek17/multitexturevs.hlsl", L"../RasterTek17/multitextureps.hlsl");
}
...
//ShaderResourceView에 배열(이중포인터)를 넘겨서 deviceContext->PSSetShaderResources(0, 2, textureArray); 의 형태로 사용한다
