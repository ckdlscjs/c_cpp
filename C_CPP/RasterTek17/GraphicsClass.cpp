...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	// 모델 객체 초기화
	if (!m_Model->Initialize(m_Direct3D->GetDevice(), "../RasterTek17/data/square.txt",
		L"../RasterTek17/data/stone01.dds", L"../RasterTek17/data/dirt01.dds", L"../RasterTek17/data/light01.dds"))
	{
